...
let project_list = [
	...
	{/* -------------------------------- need to take a screen shot of the page and update that here */
		...
		title: 'Crypto World',
		des:
			"An API based Front End Application that lets user interact and get news, prices and more information about the Crypto World.",
		tags: ['React', 'JavaScript', 'API', 'MongoDB'],
		links: {
			launch: 'https://mauscryptoworld.netlify.app/',
			github: 'https://github.com/maurya512/cryptoworld'
		}
	},
